...
const Movies = () => {
  ...
  const fetchMovies = async () => {
    const { data } = await axios.get(
      `https://api.themoviedb.org/3/discover/movie?api_key=cebdf129ce62ae24355f1a8ad713183d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`
    );
    console.log(data)
  ...
  return <div>
      ...
      <div className='mt-5 text-white flex flex-row mx-10 sm:mx-20 md:mx-30 lg:mx-40  font-sans'>
       ...
       <h1 className='ml-3 text-[27px] text-white'>Movies</h1>
        </div>
